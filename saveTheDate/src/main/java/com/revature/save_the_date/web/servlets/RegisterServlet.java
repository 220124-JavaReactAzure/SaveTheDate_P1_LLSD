...
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		resp.getWriter().write("<ul>"
				...
				+ "<li>	"
				+ "<label for'gname'>Please enter Groom's Name:</label><input type='text' id='gname'  name='gname'/></form></li>"
				...
				+ "<input type='radio' name='P_response' id='No' value='No'/><label for 'No'>No</label></li>"
				+ "</div>"
				
				+ "<div class='submit'><input type='submit' value='Register' id='submit'/></div>");
