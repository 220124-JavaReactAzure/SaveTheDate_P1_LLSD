...
public class FoodServlet extends HttpServlet{
	/*
	 * private final FoodService foodService; private final ObjectMapper mapper;
	 * 
	 * public FoodServlet(FoodService foodService, ObjectMapper mapper) {
	 * this.foodService = foodService ; this.mapper = mapper; }
	 * 
	 * @Override protected void doPost(HttpServletRequest req, HttpServletResponse
	 * resp) throws ServletException, IOException {
	 * 
	 * resp.setContentType("application/json"); try { Food newFood =
	 * mapper.readValue(req.getInputStream(), Food.class); boolean wasRegistered =
	 * foodService.addFood(newFood); if (wasRegistered) { resp.setStatus(200); }
