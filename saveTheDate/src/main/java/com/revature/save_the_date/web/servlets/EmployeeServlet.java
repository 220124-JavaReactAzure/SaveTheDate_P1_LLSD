...
public class EmployeeServlet extends HttpServlet {
	/*
	 * private final EmployeeService employeeService; private final ObjectMapper
	 * mapper;
	 */

	/*
	 * public EmployeeServlet(EmployeeService employeeService, ObjectMapper mapper)
	 * { this.employeeService = employeeService; this.mapper = mapper; }
	 */

	/*
	 * @Override protected void doPost(HttpServletRequest req, HttpServletResponse
	 * resp) throws IOException, ServletException {
	 * resp.setContentType("application/json"); try { Employee newEmployee =
	 * mapper.readValue(req.getInputStream(), Employee.class); boolean wasRegistered
	 * = employeeService.addEmployee(newEmployee); if (wasRegistered) {
