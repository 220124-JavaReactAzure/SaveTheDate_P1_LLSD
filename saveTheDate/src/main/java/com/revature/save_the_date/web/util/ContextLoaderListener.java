...
public class ContextLoaderListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		 ...
		 * 
		 * 
		 * EmployeeDAO employeeDAO = new EmployeeDAO(); EmployeeService employeeService
		 * = new EmployeeService(employeeDAO); EmployeeServlet employeeServlet = new
		 * EmployeeServlet(employeeService,mapper);
		 * 
		 * 
		 * VenueDAO venueDAO = new VenueDAO(); VenueService venueService = new
		 * VenueService(venueDAO); VenueServlet venueServlet = new
		 * VenueServlet(venueService,mapper);
		 * 
		 ...
		 * FoodService(foodDAO); FoodServlet foodServlet = new
		 * FoodServlet(foodService,mapper);
		 * 
		 * 
		 ...
		 * context.addServlet("RegistryServlet",registryServlet).addMapping(
		 * "/registry/*");
		 * context.addServlet("FoodServlet",foodServlet).addMapping("/food/*");
		 * context.addServlet("GuestServlet",guestServlet).addMapping("/guest/*");
		 * //context.addServlet("EmployeeServlet",employeeServlet).addMapping(
		 * "/employee/*");
		 * context.addServlet("VenueService",venueServlet).addMapping("/venue/*");
		 */
